            ...
            <div class="content-side content-side-full">
                ...
                <ul class="nav-main">
                    ...
                    <router-link to="/" tag="li" exact>
                        <a><i class="si si-home"></i><span class="sidebar-mini-hide">Home</span>
                        </a>
                    </router-link>

                    <router-link to="/deliveries/today" tag="li" >
                        <a><i class="si si-basket-loaded"></i><span class="sidebar-mini-hide">Pending Deliveries</span>
                        </a>
                    </router-link>

                    <router-link to="/deliveries/today" tag="li" >
                        <a><i class="si si-basket"></i><span class="sidebar-mini-hide">Today Deliveries</span>
                        </a>
                    </router-link>
