		...
		<a class="block block-rounded block-link-shadow" href="javascript:void(0)">
			<div class="block-content block-content-full block-sticky-options">
				...
				<div class="py-20 text-center">
					<div class="font-size-h2 font-w700 mb-0" data-toggle="countTo" data-to="30">{{ $numberOfUsers }}</div>
					<div class="font-size-sm font-w600 text-uppercase text-muted">{{ $action1 }} </div>
				</div>
			</div>
		</a>
	</div>
